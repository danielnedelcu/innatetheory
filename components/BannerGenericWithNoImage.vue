<template>
  <section class="section__banner p-b-250 row-mobile">
    <div class="wrapper section__banner-wrapper banner-dimmer">
      <div v-inview:once.enter="inviewImageEnter" class="section__banner-wrapper-image anim-image">
        <div class="section__banner-wrapper-center table-content">
          <div class="wrapper">
            <SectionHeadline :label="data.label" :title="data.title" />

            <div class="section__content">
              <div v-inview:once.enter="inviewEnter" class="animated__h headline-content">
